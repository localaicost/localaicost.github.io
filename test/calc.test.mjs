...
// --- breakeven: net $9600, 271.52 t/s @ 4 h/day, $0.47/M → 14.31 y
assert.ok(Math.abs(C.breakevenYears(9600, 271.515, 4, 0.47) - 14.31) < 0.02);
...
// FIT + BUY: 14B on 3090 at 12 h/day → ~1.4 y
