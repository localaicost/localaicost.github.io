...
- **TFLOPS** is FP16-dense class; sources and estimates are in the data table.
...
| GPU specs, non-price — H100 PCIe 80 GB @ 2.0 TB/s, 350 W, FP16-dense 756; H100 NVL 94 GB @ 3.9 TB/s, 350–400 W, 835; H200 141 GB @ 4.8 TB/s, 700 W, 989; B200 192 GB @ 8 TB/s, 1000 W, 2,250; B300 288 GB @ 8 TB/s, 1100 W, ~2,500 (HGX SKU 2,200); PRO 6000 96 GB @ 1792 GB/s, 600 W, FP16 504 (TF32 126); 3090 24 GB @ 936 GB/s, 350 W, FP16-dense 142; 4090 24 GB, 1008, 450, 330; 5090 32 GB, 1792, 575, 419; DGX Spark 128 GB @ 273 GB/s, GB10 TDP 140 W, FP16 119; M3 Ultra 512 GB @ 819 GB/s, 80-core GPU; M5 Ultra 512 GB @ 1.2 TB/s, 80-core GPU, 480 W max continuous | **Verified** 2026-09-12 — NVIDIA product pages, Hopper in-depth brief, Blackwell tech brief v2.1, GB200/GB300 NVL72 tables; Apple newsroom (2025-03, 2026-08-25). PRO 6000 / 5090 TFLOPS user-provided 2026-09-13; GB10 TFLOPS TechPowerUp GPU DB (user-provided 2026-09-13) |
| Model tiers + KV/token (V4-Flash 284B/13B; GLM-5.3-Flash 320B/18B 1M ctx; Flash-Next 125B/6B; 27B dense) | **Verified** — HF configs/model cards, re-checked 2026-09-12; incl. 27B `kvPerKGB` corrected 0.256→0.0655. GLM/DS-V4 KV values are estimates |
...
| Depreciation 25%/yr on all cards | **Assumption** (user set, 2026-09-13) — typical computer-hardware depreciation; a real 12-mo Mac trade-in returned 11% |
| RTX 4090 $1,600 / RTX 5090 $2,400 / 2×4090 $3,200 | **Unverified estimates** — enter real quotes |
| Used RTX 3090 $946 (+48% Jan→Jun) | **Unverified** — from the video; edit to your real number |
...
| Idle power per card; DGX Spark 170 W whole-box; M3 Ultra 280 W, 40 TFLOPS; M5 Ultra 72 TFLOPS; 2×4090 1500 GB/s, 600 TFLOPS, 950 W | **Estimates** — no published per-SKU figure (2×4090 bandwidth = 75% of 2×1008 for PCIe overhead) |
